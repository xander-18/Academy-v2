...
def recognize_gesture(image, hand_landmarks):
    """Recognize hand gestures based on the position of the fingertips."""
    image_height, image_width, _ = image.shape
    ...
    if abs(thumb_tip[1] - index_finger_pip[1]) < 45 and \
       ...
       abs(thumb_tip[1] - pinky_pip[1]) < 30:
        return "A"
         ...
         abs(thumb_tip[1] - ring_finger_pip2[1]) < 40:
        return "B"
        ...
        return "C"
    elif euclidean_distance(thumb_tip, middle_finger_tip) < 65 and \
         euclidean_distance(thumb_tip, ring_finger_tip) < 65 and \
         pinky_pip[1] - pinky_tip[1] < 0 and \
        ...
        return "E"
         ...
         euclidean_distance(index_finger_tip, thumb_tip) < 65:
        return "F"
    else:
        return "Unknown"
    ...
    while cap.isOpened():
        ...
        if results.multi_hand_landmarks:
            for hand_landmarks in results.multi_hand_landmarks:
                ...
                # Recognize gesture
                gesture = recognize_gesture(image, hand_landmarks)
